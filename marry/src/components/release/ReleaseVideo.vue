<template>
  <div class="ReleasePhoto">
    <div class="textarea-list">
      <p class="textarea-title">视频:</p>
      <div class="videoWrap"><video :src="videoSrc" controls="controls">您的浏览器不支持 video 标签。</video></div>
    </div>
    <div class="textarea-list">
    ...
    <div class="Release-wrap">
      ...
      <ul class="releaseType">
        <li v-for="(item,index) in releaseType" @click="onRelease(index)" :class="typeIndex==index?'ontype':''">{{item}}</li>
      </ul>
    </div>
    <div class="temp"></div>
    ...
    export default {
      ...
      data() {
        return {
          remnant: 30,
          desc: '',
          videoSrc:require('../../../static/img/del/uuai.mp4'),
          fileUp: [
